          ...
          <div className="row">
              ...
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/1.jpg" alt="" />
                  </a>
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/2.jpg" alt="" />
                  </a>
                  <ul className="ps-product__actions">
                    <li>
                      <a
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/3.jpg" alt="" />
                  </a>
                  <ul className="ps-product__actions">
                    <li>
                      <a
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/4.jpg" alt="" />
                  </a>
                  <ul className="ps-product__actions">
                    <li>
                      <a
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/5.jpg" alt="" />
                  </a>
                  <ul className="ps-product__actions">
                    <li>
                      <a
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/6.jpg" alt="" />
                  </a>
                  <ul className="ps-product__actions">
                    <li>
                      <a
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/7.jpg" alt="" />
                  </a>
                  <ul className="ps-product__actions">
                    <li>
                      <a
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/8.jpg" alt="" />
                  </a>
                  <div className="ps-product__badge">12%</div>
                  <ul className="ps-product__actions">
                    <li>
                      <a
                        href="#0"
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/9.jpg" alt="" />
                  </a>
                  <div className="ps-product__badge">12%</div>
                  <ul className="ps-product__actions">
                    <li>
            ...
            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 ">
              <div className="ps-product">
                <div className="ps-product__thumbnail">
                  <a href="product-default.html">
                    <img src="img/products/organic/10.jpg" alt="" />
                  </a>
                  <div className="ps-product__badge">12%</div>
                  <ul className="ps-product__actions">
                    <li>
