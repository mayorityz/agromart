      ...
      <div class="ps-page--single">
        ...
        >
          <div class="container">
            ...
            <a class="ps-btn ps-btn--lg" href="#0">
              Start Selling
            </a>
          </div>
        </div>
        <div class="ps-section--vendor ps-vendor-about">
          <div class="ps-section__header">
            ...
            <h4>
              Join a marketplace where nearly 50 million buyers around <br />{" "}
          ...
          <div class="ps-section__content">
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                <div class="ps-block--icon-box-2">
                  <div class="ps-block__thumbnail">
                    <img src="img/icons/vendor-1.png" alt="" />
                  </div>
              ...
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                <div class="ps-block--icon-box-2">
                  <div class="ps-block__thumbnail">
                    <img src="img/icons/vendor-2.png" alt="" />
                  </div>
                  <div class="ps-block__content">
              ...
              <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                <div class="ps-block--icon-box-2">
                  <div class="ps-block__thumbnail">
                    <img src="img/icons/vendor-3.png" alt="" />
                  </div>
                  <div class="ps-block__content">
                    <h4>Support 24/7</h4>
                    <div class="ps-block__desc" data-mh="about-desc">
            ...
            <div class="ps-section__content">
              <div class="ps-block--vendor-milestone">
                ...
                <div class="ps-block__right">
                  <img src="img/vendor/milestone-1.png" alt="" />
                </div>
              ...
              <div class="ps-block--vendor-milestone reverse">
                ...
                <div class="ps-block__right">
                  <img src="img/vendor/milestone-2.png" alt="" />
                </div>
                <div class="ps-block__number">
                  <span>2</span>
                </div>
              ...
              <div class="ps-block--vendor-milestone">
                ...
                <div class="ps-block__right">
                  <img src="img/vendor/milestone-3.png" alt="" />
                </div>
                <div class="ps-block__number">
                  <span>3</span>
                </div>
              ...
              <div class="ps-block--vendor-milestone reverse">
                ...
                <div class="ps-block__right">
                  <img src="img/vendor/milestone-4.png" alt="" />
                </div>
                <div class="ps-block__number">
                  <span>4</span>
                </div>
        ...
        >
          <div class="container">
            <h2>It's time to start making money.</h2>
            <a class="ps-btn ps-btn--lg" href="#0">
              Start Selling
            </a>
          </div>
